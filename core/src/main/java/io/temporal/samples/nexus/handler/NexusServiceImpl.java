...
public class NexusServiceImpl {
  ...
  public OperationHandler<NexusService.EchoInput, NexusService.EchoOutput> echo() {
    // OperationHandler.sync is meant for exposing simple RPC handlers.
    return OperationHandler.sync(
        ...
        // calling Nexus.getOperationContext().getWorkflowClient(ctx) to make arbitrary calls such as
